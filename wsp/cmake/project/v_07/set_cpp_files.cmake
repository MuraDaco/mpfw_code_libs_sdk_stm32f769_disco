...
set(CODE_SDK_SDK_INTERRUPT
    ${LIBS_SDK_PLATFORM_DIR}/src/sdk/sdkInterrupt/v_${SDK_PLATFORM_INTERRUPT_LIB_VER}/sdkInterruptUnit.c
    ${LIBS_SDK_PLATFORM_DIR}/src/sdk/sdkInterrupt/v_${SDK_PLATFORM_INTERRUPT_LIB_VER}/sdkInterruptManager.c
)

set(CODE_SDK_SDK_STARTUP
    ${LIBS_SDK_PLATFORM_DIR}/src/sdk/sdkStartup/v_${SDK_PLATFORM_STARTUP_LIB_VER}/startup_stm32f769xx.s
    ${LIBS_SDK_PLATFORM_DIR}/src/sdk/sdkStartup/v_${SDK_PLATFORM_STARTUP_LIB_VER}/syscalls.c
    ${LIBS_SDK_PLATFORM_DIR}/src/sdk/sdkStartup/v_${SDK_PLATFORM_STARTUP_LIB_VER}/system_stm32f7xx.c
)

set(CODE_SDK_SDK_MPU
    ${LIBS_SDK_PLATFORM_DIR}/src/sdk/sdkMpu/v_${SDK_PLATFORM_MPU_LIB_VER}/sdkMpu.c
)
...
## xxx set(CODE_SDK_INTERRUPTS
## xxx     ${LIBS_SDK_PLATFORM_SRC_DIR}/Interrupts/stm32f7xx_it.c
## xxx )
